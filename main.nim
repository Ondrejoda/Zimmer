...
while engine.running:
    ...
    if engine.keyboard[SDL_SCANCODE_LEFT.int] > 0:
        obj.apply_impulse(-0.3, 0.0)
    if engine.keyboard[SDL_SCANCODE_RIGHT.int] > 0:
        obj.apply_impulse(0.3, 0.0)
    if engine.keyboard[SDL_SCANCODE_UP.int] > 0:
        obj.apply_impulse(0.0, -0.3)
    if engine.keyboard[SDL_SCANCODE_DOWN.int] > 0:
        obj.apply_impulse(0.0, 0.3)
